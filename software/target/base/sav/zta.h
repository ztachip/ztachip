...
#define ZTAH_GREG(base,dpreg,reg)   ((volatile uint32_t *)((((0 << 15)+(dpreg << 6)+reg)<<2)+(uint32_t)(base)))
#define ZTAH_GREGF(base,dpreg,reg)  ((volatile float *)((((0 << 15)+(dpreg << 6)+reg)<<2)+(uint32_t)(base)))
