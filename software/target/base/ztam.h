...
/* ztamMsgReadAvail: Number of received messages ready to be read */
extern int ztamMsgqReadAvail(int queue);
/* ztamMsgReadInt: Read an integer sent from host */
extern int32_t ztamMsgqReadInt(int queue);
/* ztamMsgReadPointer: Read a pointer sent from host */
extern uint32_t ztamMsgqReadPointer(int queue);
