...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot mig_7series_0 xil_defaultlib.mig_7series_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim mig_7series_0 -key {Behavioral:sim_1:Functional:mig_7series_0} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_1779.protoinst" -protoinst "protoinst_files/crossbar.protoinst" -log simulate.log
}
