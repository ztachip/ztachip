package vexriscv.VexRiscvForJtag
...
case class VexRiscvForJtag(config : RiscvConfig) extends Component{
  import config._
...
object VexRiscvForJtag{
  def main(args: Array[String]) {
    SpinalVhdl(VexRiscvForJtag(RiscvConfig.default.copy()))
  }
}
