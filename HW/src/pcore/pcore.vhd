...
alu_0_i: alu generic map(INDEX=>0)
...
alu_1_i: alu generic map(INDEX=>1)
            port map(clock_in=>clock_in,
                              reset_in=>reset_in,
                              mu_opcode_in=>mu_opcodes,
                              mu_tid_in=>mu_tid,
...
alu_2_i: alu generic map(INDEX=>2)
            port map(clock_in=>clock_in,
                              reset_in=>reset_in,
                              mu_opcode_in=>mu_opcodes,
                              mu_tid_in=>mu_tid,
...
alu_3_i: alu generic map(INDEX=>3)
            port map(clock_in=>clock_in,
                              reset_in=>reset_in,
                              mu_opcode_in=>mu_opcodes,
                              mu_tid_in=>mu_tid,
...
alu_4_i: alu generic map(INDEX=>4)
            port map(clock_in=>clock_in,
                              reset_in=>reset_in,
                              mu_opcode_in=>mu_opcodes,
                              mu_tid_in=>mu_tid,
...
alu_5_i: alu generic map(INDEX=>5)
            port map(clock_in=>clock_in,
                              reset_in=>reset_in,
                              mu_opcode_in=>mu_opcodes,
                              mu_tid_in=>mu_tid,
...
alu_6_i: alu generic map(INDEX=>6)
            port map(clock_in=>clock_in,
                              reset_in=>reset_in,
                              mu_opcode_in=>mu_opcodes,
                              mu_tid_in=>mu_tid,
...
alu_7_i: alu generic map(INDEX=>7)
            port map(clock_in=>clock_in,
                              reset_in=>reset_in,
                              mu_opcode_in=>mu_opcodes,
                              mu_tid_in=>mu_tid,
