...
SIGNAL dp_read_vector_vm1:unsigned(core_vector_depth_c-1 downto 0);
SIGNAL dp_read_vector_vm2:unsigned(core_vector_depth_c-1 downto 0);
SIGNAL dp_read_vaddr_vm1:std_logic_vector(core_vector_depth_c-1 downto 0);
SIGNAL dp_read_vaddr_vm2:std_logic_vector(core_vector_depth_c-1 downto 0);
...
SIGNAL dp_readdata_vm1:STD_LOGIC_VECTOR(core_data_width_c-1 downto 0);
SIGNAL dp_readdata_vm2:STD_LOGIC_VECTOR(core_data_width_c-1 downto 0);
...
SIGNAL dp_read_scatter_cnt_vm1:unsigned(core_vector_depth_c-1 downto 0);
SIGNAL dp_read_scatter_vector_vm1:unsigned(core_vector_depth_c-1 downto 0);
SIGNAL dp_read_scatter_vm2:scatter_t;
SIGNAL dp_read_scatter_cnt_vm2:unsigned(core_vector_depth_c-1 downto 0);
SIGNAL dp_read_scatter_vector_vm2:unsigned(core_vector_depth_c-1 downto 0);
...
SIGNAL dp_rd_scatter_cnt_r:unsigned(core_vector_depth_c-1 downto 0);
SIGNAL dp_rd_scatter_vector_r:unsigned(core_vector_depth_c-1 downto 0);
...
SIGNAL dp_rd_scatter_cnt_rr:unsigned(core_vector_depth_c-1 downto 0);
SIGNAL dp_rd_scatter_vector_rr:unsigned(core_vector_depth_c-1 downto 0);
